...
import { totalSummGameInCart } from "../../features/addGameToCartSlice";

import IGameItemProps from "../../types/GameItem";

export const GameInCart: React.FC<IGameItemProps> = ({ game, some = 1, clickGame }) => {
...
const s = () => {
  dispatch(totalSummGameInCart(gamePriceCount))
}
      ...
      <div key={uuidv4()} className={styles.game}>
        ...
        {/* <div>
         ...
         <div>
          ...
          <span className={styles.gameCount}>{}</span>
          <span
            className={styles.count}
            onClick={s}
          >
