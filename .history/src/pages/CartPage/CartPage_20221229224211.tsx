...
import { deleteAllFromCart, incrGameCount } from "../../features/addGameToCartSlice";
            ...
            return (
              <div key={uuidv4()} className={styles.game}>
                ...
                <div>
                  ...
                  <span className={styles.gameCount}>{item.count}</span>
                  <span
                    className={styles.count}
                    onClick={incrCountGame}
                  >
                    +
                  </span>
                </div>
